        ...
        <div>
          ...
          <form className="flex ">
            <input
              ...
              className="p-3 w-full text-sm border-t border-b border-gray-300 rounded-l-md focus:ring-2 focus:ring-gray-500"
              required
            />
            <button
              type="submit"
              className="bg-black text-white px-6 py-3 text-sm rounded-r-md hover:bg-gray-800 transition-all pt-2"
            >
              Subscribe
            </button>
          </form>
